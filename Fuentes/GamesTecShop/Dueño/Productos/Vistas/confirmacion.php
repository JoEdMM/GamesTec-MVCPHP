...
<head>
    <meta charset="UTF-8">
    <title>Confirmación Eliminación de Productos - GamesTec</title>
...
<main class="scroll">
	<div class="popup">
		<h2 align="center">¿Estás seguro de borrar este Artículo?</h2>

		<form action='../Controladores/admin_producto.php' method='get' align="center">
