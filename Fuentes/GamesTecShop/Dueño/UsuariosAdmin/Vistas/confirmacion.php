...
<head>
    <meta charset="UTF-8">
    <title>Confirmación Eliminación de Usuarios Moderadores - GamesTec</title>
...
<main class="scroll">
	<div class="popup">
		<h2 align="center">¿Estás seguro de borrar este usuario?</h2>

		<form action='../Controladores/admin_usuario.php' method='get' align="center">
